...
static class ResponseHistory
{
    ...
    public static void SaveQuestion(string question, string sessionId = "", string cwd = "")
    {
        ...
        lock (_lock)
        {
            ...
            entries.Add(new HistoryEntry("ProdToy", "", question.Trim(), NotificationType.Pending, DateTime.Now, sessionId, cwd));
    ...
    public static void Invalidate() { lock (_lock) { _cachedIndex = null; } }
}
