...
class AlarmEditForm : Form
{
    ...
    public AlarmEditForm(PopupTheme theme, AlarmEntry? existing = null)
    {
        ...
        _snoozePicker = new NumericUpDown
        {
            ...
            Value = existing?.SnoozeMinutes ?? AppSettings.Load().AlarmDefaultSnoozeMinutes,
    ...
    private void UpdateFieldVisibility()
    {
        ...
        // Find and update the labels by position
        foreach (Control c in Controls)
        {
    ...
    private Label AddLabel(string text, int x, int y, PopupTheme theme)
    {
        var lbl = new Label
        {
            Text = text,
