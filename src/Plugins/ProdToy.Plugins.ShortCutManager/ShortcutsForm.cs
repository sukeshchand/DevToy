...
class ShortcutsForm : Form
{
    ...
    public ShortcutsForm(PluginTheme theme)
    {
        ...
        // --- Right: tabbed pane (Shortcuts list + Consolidated launcher) ---
        ...
        // processes inside one window (embedded consoles + preview).
    ...
    {
        // Keep the Consolidated tab in sync with the currently selected folder.
        // RefreshList is the chokepoint for every state change that matters here —
        // folder switch, shortcut add/delete/edit, recycle bin enter/exit.
